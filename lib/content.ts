...
export const agents = {
  ...
  roster: [
    ...
    { n: "007", name: "CRM", glyph: "loyalty", colour: "#3E8098" },
...
export const departments = {
  ...
  panels: [
    ...
    },
    {
      ...
      tag: "Ours",
      title: "CRM & Loyalty",
      body: "Every guest on one record. Follow-ups drafted, loyalty cards tracked, and the regular who stopped coming gets noticed.",
      runsOn: "Ours, inside Peregrine",
      waits: "Anything that reaches a guest",
    },
    {
      n: "008",
      art: "roster" as const,
      title: "Rostering & Admin",
      body: "Drafted against forecast and award rates, labour shown as a share of the day. Renewals tracked before they lapse.",
      runsOn: "The forecast · award rates · timesheets",
      waits: "Every week",
    },
    {
      n: "009",
...
export const platform = {
  ...
  intro:
    "A modelled morning at a 40-cover bistro. Six departments run through the night on the systems this venue already pays for, and by open only the decisions that need a person are still on the desk. The till and the compliance file sit off this floor because this venue does not run them.",
